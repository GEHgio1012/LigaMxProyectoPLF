...
<head>
    ...
    <title>LigaMx Proyecto</title>
    <link rel="icon" type="image/x-icon" href="recursos/MX_logo.png">
...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img id="imagenlogo" class="imagenl" src="recursos/logoligaMx.png" alt=""></a>
