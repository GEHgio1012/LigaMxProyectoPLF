...
<footer class='pie'>
    ...
    <div class='grupo1'>
        <div class="box">
            <figure>
                <a href="https://zongolica.tecnm.mx/TecNM/">
                    <img src="recursos/liga_mx_footer.png" alt="logo del instituto tecnologico superior de zongolica">
                </a>
            </figure>
        </div>
        <div class="box">
        ...
        <div class="box">
            <h2></h2>
            <div class="redsocial">
                <p>Equipo para pagina Liga Mx para la materia de Programacion Logica y Funcional</p>
    ...
    <div class="grupo2">
        <small>&copy; 2021 <b>Instituto Tecnologico Superior de Zongolica</b> - Todos los Derechos Reservados </small>
    </div>
    </section>
</footer>
